  ...
  test('[GET] /answers/:answerId/comments', async () => {
    ...
    expect(response.body).toEqual({
      comments: expect.arrayContaining([
        expect.objectContaining({ content: fakeAnswerComments[0].content }),
        expect.objectContaining({ content: fakeAnswerComments[1].content }),
        expect.objectContaining({ content: fakeAnswerComments[2].content }),
      ]),
    })
  })
})